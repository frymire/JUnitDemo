...
public class HamcrestExamples {
  ...
  public void describedAsExample() throws Exception {
    org.hamcrest.Matcher< ?> matcher = describedAs("My Description", anything());
    org.hamcrest.Description description = new org.hamcrest.StringDescription().appendDescriptionOf(matcher);
